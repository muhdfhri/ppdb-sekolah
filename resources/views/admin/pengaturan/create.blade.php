{{-- resources/views/admin/pengaturan/create.blade.php --}}
...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <nav class="flex items-center gap-2 text-xs text-slate-400 mb-2">
                ...
                <span class="material-symbols-outlined text-sm">chevron_right</span>
                <span class="text-slate-600 font-semibold">Tambah Periode</span>
            </nav>
            <h2 class="text-3xl font-extrabold tracking-tight">Tambah Periode PPDB</h2>
    ...
    <div
        ...
        <div
            ...
            <div>
                <h4 class="font-bold">Form Tambah Periode</h4>
                <p class="text-xs text-slate-400">Isi data periode pendaftaran PPDB baru</p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.pengaturan.periode.store') }}" class="p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="tanggal_pengumuman" value="{{ old('tanggal_pengumuman') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="biaya_pendaftaran" value="{{ old('biaya_pendaftaran', 0) }}" min="0"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="tanggal_daftar_ulang_mulai" value="{{ old('tanggal_daftar_ulang_mulai') }}"
                            class="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="tanggal_daftar_ulang_selesai"
                            value="{{ old('tanggal_daftar_ulang_selesai') }}"
                            class="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all">
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Validasi tanggal tutup minimal setelah tanggal buka
                ...
                // Validasi tanggal selesai daftar ulang minimal setelah tanggal mulai
