{{-- resources/views/admin/jurusan/create.blade.php --}}
...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
    <div>
        <nav class="flex items-center gap-2 text-xs text-slate-400 mb-2">
            ...
            <span class="material-symbols-outlined text-sm">chevron_right</span>
            <span class="text-slate-600 font-semibold">Tambah Jurusan</span>
        </nav>
        <h2 class="text-3xl font-extrabold tracking-tight">Tambah Jurusan Baru</h2>
        <p class="text-slate-500 mt-1">Buat jurusan/program keahlian baru</p>
    </div>
...
<div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden">
    <div class="px-8 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center gap-3 bg-slate-50 dark:bg-slate-800/50">
        ...
        <div>
            <h4 class="font-bold">Form Tambah Jurusan</h4>
            <p class="text-xs text-slate-400">Isi data jurusan/program keahlian baru</p>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.jurusan.store') }}" class="p-8 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="kode_jurusan" value="{{ old('kode_jurusan') }}" maxlength="10" required
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="kuota" value="{{ old('kuota', 0) }}" min="0" max="999" required
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    ...
                    <textarea name="deskripsi" rows="4"
                        ...
                        placeholder="Jelaskan secara singkat tentang jurusan ini, prospek karir, atau mata pelajaran yang akan dipelajari...">{{ old('deskripsi') }}</textarea>
                </div>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="text-xs text-blue-800 dark:text-blue-300">
                    ...
                    <ul class="list-disc list-inside space-y-1">
                        ...
                        <li>Anda dapat menambahkan icon kustom dengan mengedit file iconMap</li>
                    </ul>
                </div>
            </div>
        </div>
