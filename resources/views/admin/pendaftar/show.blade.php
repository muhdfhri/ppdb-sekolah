                ...
                <div class="p-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    @php
                        $pribadi = [
                            ...
                            ['label' => 'Tanggal Lahir', 'value' => isset($pendaftaran->siswa->tanggal_lahir) ? \Carbon\Carbon::parse($pendaftaran->siswa->tanggal_lahir)->translatedFormat('d F Y') : '-'],
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                @php
                                    $ortuFields = [
                                        ...
                                        ['label' => 'Tanggal Lahir', 'value' => isset($ortu->tanggal_lahir) ? \Carbon\Carbon::parse($ortu->tanggal_lahir)->translatedFormat('d F Y') : '-'],
